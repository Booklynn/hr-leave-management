...
public class LeaveAllocationDetailsToDTOMapper : IManualMapper<Domain.LeaveAllocation, LeaveAllocationDetailsDTO>
{
    public LeaveAllocationDetailsDTO ManualMap(Domain.LeaveAllocation source)
    {
